...
4. Document containment actions: reset session, require MFA, review privileged activity, and retain evidence.
...
4. Retain audit timeline and monitor evidence.
...
4. Retain endpoint and database timeline.
...
4. Block access, retain logs, and escalate to incident response.
